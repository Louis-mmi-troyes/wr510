...
const createCustomStackNavigator = (component) => {
  return (
    <Stack.Navigator
      ...
      screenOptions={screenOptionsWithLogo} // Utilisez screenOptionsWithLogo pour tous les écrans dans cette pile
    >
      <Stack.Screen
        name="Home"
        component={component}
...
// ... Importations et composants existants
    ...
    <NavigationContainer>
      <Tab.Navigator
        screenOptions={{
          ...
          tabBarStyle: { backgroundColor: '#263238' },
        }}
      >
        <Tab.Screen
          name="Home"
  ...
  return (
    <Stack.Navigator initialRouteName='Home'>
      ...
      <Stack.Screen
        ...
        options={screenOptionsWithLogo} // Assurez-vous d'avoir aussi le logo pour la CardScreen dans le stack interne
      />
    </Stack.Navigator>
  );
};
